...
// End Cross Module References
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAnimNotify_PlayEffekseerEffect_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UAnimNotify_PlayEffekseerEffect_Statics::PropPointers),
		0,
		0x001120A0u,
		METADATA_PARAMS(Z_Construct_UClass_UAnimNotify_PlayEffekseerEffect_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UAnimNotify_PlayEffekseerEffect_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UAnimNotify_PlayEffekseerEffect, 3811198836);
