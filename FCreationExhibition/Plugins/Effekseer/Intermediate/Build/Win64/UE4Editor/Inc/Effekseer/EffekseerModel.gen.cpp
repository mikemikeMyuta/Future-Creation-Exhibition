...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UEffekseerModel_Statics::NewProp_AnimationFaceCounts = { "AnimationFaceCounts", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEffekseerModel, AnimationFaceCounts), METADATA_PARAMS(Z_Construct_UClass_UEffekseerModel_Statics::NewProp_AnimationFaceCounts_MetaData, ARRAY_COUNT(Z_Construct_UClass_UEffekseerModel_Statics::NewProp_AnimationFaceCounts_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UEffekseerModel_Statics::NewProp_AnimationFaceOffsets = { "AnimationFaceOffsets", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEffekseerModel, AnimationFaceOffsets), METADATA_PARAMS(Z_Construct_UClass_UEffekseerModel_Statics::NewProp_AnimationFaceOffsets_MetaData, ARRAY_COUNT(Z_Construct_UClass_UEffekseerModel_Statics::NewProp_AnimationFaceOffsets_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UEffekseerModel_Statics::NewProp_Mesh = { "Mesh", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEffekseerModel, Mesh), Z_Construct_UClass_UStaticMesh_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UEffekseerModel_Statics::NewProp_Mesh_MetaData, ARRAY_COUNT(Z_Construct_UClass_UEffekseerModel_Statics::NewProp_Mesh_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UEffekseerModel_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UEffekseerModel_Statics::PropPointers),
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UEffekseerModel_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UEffekseerModel_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UEffekseerModel, 4284068842);
