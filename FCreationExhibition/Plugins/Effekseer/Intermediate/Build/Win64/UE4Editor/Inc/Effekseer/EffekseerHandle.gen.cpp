...
static struct FScriptStruct_Effekseer_StaticRegisterNativesFEffekseerHandle
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FEffekseerHandle_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FEffekseerHandle_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000205),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FEffekseerHandle_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FEffekseerHandle_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FEffekseerHandle_Hash() { return 2752730842U; }
