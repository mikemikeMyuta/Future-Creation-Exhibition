...
// Cross Module References
	...
	EFFEKSEER_API UFunction* Z_Construct_UFunction_UEffekseerEmitterComponent_Exists();
	EFFEKSEER_API UFunction* Z_Construct_UFunction_UEffekseerEmitterComponent_Play();
	EFFEKSEER_API UScriptStruct* Z_Construct_UScriptStruct_FEffekseerHandle();
	EFFEKSEER_API UFunction* Z_Construct_UFunction_UEffekseerEmitterComponent_Stop();
	EFFEKSEER_API UFunction* Z_Construct_UFunction_UEffekseerEmitterComponent_StopRoot();
...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UEffekseerEmitterComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UEffekseerEmitterComponent_Exists, "Exists" }, // 1168976736
		{ &Z_Construct_UFunction_UEffekseerEmitterComponent_Play, "Play" }, // 3039602227
		{ &Z_Construct_UFunction_UEffekseerEmitterComponent_Stop, "Stop" }, // 1344798782
		{ &Z_Construct_UFunction_UEffekseerEmitterComponent_StopRoot, "StopRoot" }, // 3387231232
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UEffekseerEmitterComponent_Statics::NewProp_Speed = { "Speed", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEffekseerEmitterComponent, Speed), METADATA_PARAMS(Z_Construct_UClass_UEffekseerEmitterComponent_Statics::NewProp_Speed_MetaData, ARRAY_COUNT(Z_Construct_UClass_UEffekseerEmitterComponent_Statics::NewProp_Speed_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UEffekseerEmitterComponent_Statics::NewProp_IsLooping = { "IsLooping", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UEffekseerEmitterComponent), &Z_Construct_UClass_UEffekseerEmitterComponent_Statics::NewProp_IsLooping_SetBit, METADATA_PARAMS(Z_Construct_UClass_UEffekseerEmitterComponent_Statics::NewProp_IsLooping_MetaData, ARRAY_COUNT(Z_Construct_UClass_UEffekseerEmitterComponent_Statics::NewProp_IsLooping_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UEffekseerEmitterComponent_Statics::NewProp_bAutoDestroy = { "bAutoDestroy", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UEffekseerEmitterComponent), &Z_Construct_UClass_UEffekseerEmitterComponent_Statics::NewProp_bAutoDestroy_SetBit, METADATA_PARAMS(Z_Construct_UClass_UEffekseerEmitterComponent_Statics::NewProp_bAutoDestroy_MetaData, ARRAY_COUNT(Z_Construct_UClass_UEffekseerEmitterComponent_Statics::NewProp_bAutoDestroy_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UEffekseerEmitterComponent_Statics::ClassParams = {
		...
		ARRAY_COUNT(Z_Construct_UClass_UEffekseerEmitterComponent_Statics::PropPointers),
		0,
		0x00B000A4u,
		METADATA_PARAMS(Z_Construct_UClass_UEffekseerEmitterComponent_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UEffekseerEmitterComponent_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UEffekseerEmitterComponent, 850280743);
